...
pub const CATALOG: &[CatalogModel] = &[
    ...
    CatalogModel {
        ...
        tier: Tier::Fast,
        label: "Qwen3.5 4B",
        description: "Lightweight on-device default. Hybrid thinking and native tool calling on 8GB Macs.",
    ...
    CatalogModel {
        ...
        tier: Tier::Balanced,
        label: "Qwen3.5 9B",
        description: "Recommended on-device default. Best quality that runs comfortably on a 16GB Mac.",
    ...
    CatalogModel {
        ...
        tier: Tier::Max,
        label: "Qwen3.6 27B",
        description: "Strongest on-device Qwen. Near-frontier agentic quality; needs 48GB of unified memory.",
